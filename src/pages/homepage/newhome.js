...
export class Newhome extends Component {
    ...
    componentDidMount() {
        ...
        return fetch(`https://newdawnadmin.onrender.com/blog`)
                        ...
                        <div className="container">
                            <div className="homecontainer-text">
                                ...
                                <button className="main-btn">
                                    <NavLink to="/college/contact" className="btn-nav">Contact</NavLink>
                                </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-lg-6 col-md-12 col-sm-12">
                                ...
                                <div className="home-btn" style={{ textAlign: "center" }}>
                                    <button className="main-btn">
                                        <NavLink to="/college/about" className="btn-nav">Learn more</NavLink>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="container">
                            ...
                            {this.state.loading ? (<div>
                                ...
                                <Slider {...homeblog} className="home-blog-slide">
                                    {this.state.data.sort((a, b) => moment(new Date(b.id)) - moment(new Date(a.id))).map((item) => {
                                        return (
                                            <div key={item?._id} className="container">
                                                <div className="blog-container">
                                                    <div className='home-blogImage'><img src={item?.image} alt="loading" className="homeblog-img" /></div>
                                                    <div className="home-blog-title">{item?.title}</div>
                                                    <div className="home-blogdate">{moment(item?.createdAt).format("MMMM Do YYYY")}</div>
                                                    <div className="homeblog-text">{item?.excerpt}</div>
                                                    <div className="homeblog-readmore">
                                                        <NavLink to={`/newsupdate/${item.title.split(" ").join("-")}`} className="homeblognav">Read More </NavLink></div>
                                                </div>
                                            </div>
                                        )
                                    })}
                            ...
                            <div className="" style={{ textAlign: "center", paddingBottom: "40px" }}>
                                <button className="main-btn" style={{ marginTop: "0px" }}>
                                    <NavLink to="/college/newsupdate" className="btn-nav">View all posts</NavLink>
                                </button>
                            </div>
